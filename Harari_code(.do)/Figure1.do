...
log using ${logfolder}/Figure1.log, replace 
...
replace metric="1. Disconnection, km" if metric=="disconnect"
replace metric="2. Remoteness, km" if metric=="remoteness"
replace metric="3. Spin, km2" if metric=="spin"
replace metric="4. Range, km" if metric=="range"
